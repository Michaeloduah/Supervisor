...
import { MdOutlineAttachEmail, MdLockOutline } from "react-icons/md";
    ...
    <form>
      ...
      <div className="mb-6 flex items-center justify-between gap-2 py-2">
        ...
        <Link
          ...
          className="select-none font-satoshi text-base font-medium text-dark underline duration-300 hover:text-[#13802a] dark:text-white dark:hover:text-[#13802a]"
        >
          Forgot Password?
        </Link>
      </div>
      ...
      <div className="mb-4.5">
        <button
          type="submit"
          className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-[#13802a] p-4 font-medium text-white transition hover:bg-opacity-90"
        >
          Sign In
        </button>
      </div>
