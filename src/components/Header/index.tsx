...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-[#13802a] dark:bg-gray-dark">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm bg-[#13802a] p-1.5 shadow-sm dark:bg-dark-2 lg:hidden"
          >
